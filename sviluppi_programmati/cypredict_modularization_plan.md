...
- Prossima fase consigliata: iniziare una fase separata di pulizia import/log/commenti sui moduli gia' estratti, aggiungere smoke test mirati per `multiperiod_analysis` e min/max, e poi introdurre il service per GammaSignalForge.
